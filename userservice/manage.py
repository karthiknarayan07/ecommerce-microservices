...
def main():
    ...
    if environment == "development":
        ...
        os.environ["DJANGO_SETTINGS_MODULE"] = "userservice.settings.dev"
    elif environment == "stage":
        print("Loading stage settings file for Django configurations")
        os.environ["DJANGO_SETTINGS_MODULE"] = "userservice.settings.stage"
    elif environment == "production":
        print("Loading production settings file for Django configurations")
        os.environ["DJANGO_SETTINGS_MODULE"] = "userservice.settings.prod"
    else:
        print("Loading local settings file for Django configurations")
        os.environ["DJANGO_SETTINGS_MODULE"] = "userservice.settings.local"
